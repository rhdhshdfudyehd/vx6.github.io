$(document).ready(function() {
    $('.mobile-menu-btn').on('click', function() {
        $('.mobile-nav-links').html($('.nav-links').html());
    ...
    $('#buyBtn').click(function() {
        ...
        // 更新模态框中的信息
        $('#product_name').text($('.product-title').text());
        ...
        const qrCode = new QRCodeStyling({
            ...
            type: "canvas",
            data: found[1],
            image: '/static/sdamka/img/'+ selectedPayment.toLowerCase() +'.png',
            imageOptions: {
